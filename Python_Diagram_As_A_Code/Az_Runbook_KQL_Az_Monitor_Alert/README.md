...
| :--- |
| **Structured Ingestion and Schema:** Native tables (`AzureDiagnostics`) for specific business reporting needs.
| **Smart Routing:** Routes alerts to specific **Teams Channels** (Info, Warn, Error) based on severity.
